...
const { t } = useLang()
const fromhere = ref(
  '經系統分析,該表單來自隱形牙箍兒童專線頁面,来源地址：https://smilepartner.hk/clear-aligners-child'
)
// compiler macro
definePageMeta({
  layout: 'page',
  ...
  <div>
        ...
        <div class="page_body_header_fixed">
          ...
          <div class="head_banner_text justify-self-center">
            <div class="head_banner_text_p">
              ...
              <div
                target="_blank"
                class="text-pink text-center flex justify-center mt-4 items-center banner_top_mb"
              >
                <img
                  src="https://static.cmereye.com/imgs/2022/12/398e13e885db0aa2.png"
                  alt=""
                />
              ...
              <div class="banner-text">
                <p class="pt-8">
                  專為正值換牙及發育時期小朋友設計的矯齒療程，在註冊牙醫跟進下，證實能改善簡單至複雜的早期兒童牙齒問題，如牙縫過大、錯咬、牙弓狹小令牙齒擠迫不齊等，讓你的小朋友於成長路上能盡情展現燦爛笑容。
                </p>
                <div
    ...
    <div class="page_orthodontic md:pb-20 sm:py-24">
      <div class="page_container">
        <div
          class="orthodontic_title justify-center text-center sm:text-center mt-5 py-14 z-10"
        >
          <h2
            class="text-primary font-normal text-xl md:text-2xl inline-block relative pcShow"
          >
            隱形牙箍兒童專線3大優點
          </h2>
          <h2
            class="text-primary font-normal text-xl md:text-2xl inline-block relative mbShow"
        ...
        <div class="md:flex Advantages">
          <div class="Advantages-box">
            <img
              src="https://static.cmereye.com/imgs/2022/12/f16c338cee491f14.png"
              alt=""
            />
            <div>
              <p class="text-center text-green mt-3">無礙日常活動</p>
              <span>
                相比傳統鋼箍，隱形牙箍可以避免鋼線或骨釘刮傷口腔，同時小朋友於吹奏樂器、做運動、演講時，都可以除低隱形牙箍，切合日常需要，無阻他們的多元興趣發展！</span
              >
            </div>
          </div>
          <div class="Advantages-box">
            <img
              src="https://static.cmereye.com/imgs/2022/12/9286f395893e34df.png"
              alt=""
            />
            <div>
              <p class="text-center text-pink mt-3">
                有效了解小朋友佩戴牙箍時間
              </p>
              <span>
                可於隱形牙箍上加上藍色依從性顯示點，方便你隨時檢查小朋友佩戴牙箍時間是否足夠，確保有最佳矯齒效果。</span
              >
            </div>
          </div>
          <div class="Advantages-box">
            <img
              src="https://static.cmereye.com/imgs/2022/12/36845ddc0f1516c0.png"
              alt=""
            />
            <div>
              <p class="text-center text-green mt-3">複雜問題都可解決</p>
              <span
                >我們選用的隱形牙箍有「輔助翼托」設計，可達到將下顎向前移的作用，有效改善小朋友哨牙等問題。</span
              >
            </div>
          </div>
        </div>
    ...
    <div class="page_orthodontic orthodontic_compete md:pb-64 pb-28">
      <div class="page_container">
        <div
          class="orthodontic_title text-center sm:text-center mt-5 py-14 z-10"
        >
          <h2
        ...
        <div class="flex md:flex-row flex-col">
          <div class="w-full sm:px-4 compete_bac pcShow">
            <div class="compete_bac_box">
              <img
                src="https://static.cmereye.com/imgs/2022/12/5ddf8e49fc959140.jpg"
                alt=""
                class="compete_bac_1"
              />
              <img
                src="https://static.cmereye.com/imgs/2022/12/111bd9beff5dca62.png"
                alt=""
                class="compete_bac_2"
              />
            </div>
            <div class="compete_one">
              ...
              <p class="">
                ...
                小朋友可能因牙齒排列問題，而不敢露齒笑，繼而或會影響他們的自信。
              </p>
            </div>
            <div class="compete_two">
              ...
              />
              <p class="">
                <span class="text-pink">影響咀嚼及說話發音，嚴重可致面歪</span
                ><br />
                牙齒「錯咬」問題嚴重可致咀嚼困難，甚至影響說話發音，更有可能導致面歪，繼而需要進行調整顎骨手術。
              </p>
            </div>
            <div class="compete_three">
              ...
              <p class="">
                ...
                牙齒不齊，日常較難徹底清潔牙齒，長久下來增加患上蛀牙及牙周病等牙齒疾病的風險。
              </p>
            </div>
          </div>
          <div
    ...
    <div class="page_orthodontic md:pb-20">
      <div class="flex flex-col items-center" style="display: none">
        ...
        <iframe
          ...
          title="【#希瑪牙科中心中環中建大廈店】1分鐘帶你參觀希瑪牙科中環店📽️📺👀"
          frameborder="0"
      ...
      <div class="page_container">
        <div
          class="orthodontic_title step_title text-center sm:text-center mt-5 py-14 z-10"
        >
          <h2
            class="text-primary font-normal text-xl md:text-2xl inline-block relative"
          >
              ...
              <div class="mx-auto w-full rounded-2xl p-2 orthodontic_faq_list">
                <Disclosure v-slot="{ open }">
                  ...
                  >
                    ...
                    >
                      小朋友的牙齒排列問題不可小看，愈遲改善，影響範圍就愈廣泛。及早開始矯齒，不但有助減低治療複雜性，改善面型及輪廓等問題都會較有效。
...
@media screen and(min-width:768px) {
  ...
  .page_body_header_banner {
    background-image: url(https://static.cmereye.com/imgs/2022/12/29afff14b9956318.jpg);
    background-size: 100% auto;
    background-repeat: no-repeat;
    background-position: top;
    background-attachment: fixed;
...
@media screen and(max-width:768px) {
  ...
  .orthodontic_step .flex_between_items_start > div:nth-child(1) h4::after {
    position: absolute;
    left: -69px;
    right: 0;
    top: 0;
  ...
  .page_body_header_fixed .head_banner_text_p .head_banner_img,
  .page_body_header_fixed .head_banner_text_p h2 {
    display: block;
  }
  .orthodontic_table {
    width: 148vw;
