...
<template>
  ...
  <div class="page_orthodontic pb-20">
    <div class="">
      <div
        class="orthodontic_title step_title text-center sm:text-center md:mb-20 py-10 z-10"
      >
        <h2
      ...
      <div class="orthodontic_step page_container">
        ...
        <!-- <div class="flex23123_between_items_start">
          <div class="sm:w-6/13">
        ...
        <div class="flex flex-col">
          <div class="w-full compete_bac pcShow px-16">
            ...
            <div class="compete_two">
              ...
              <p class="">
                拍攝X光片，全方位分析你的牙齒及笑容比例，了解你對療程嘅需求同期望，微量修磨牙齒表面及印製牙模，以度身設計及訂製專屬瓷牙貼片
              </p>
            </div>
            ...
            <div class="compete_bac_box">
              <img
                src="https://static.cmereye.com/imgs/2022/11/2c52f2c14320f071.jpg"
                alt=""
                class="compete_bac_1"
              />
            </div>
